...
-- Generation Time: Jan 11, 2022 at 01:26 PM
...
(23, 16, 4, 'COucou'),
(25, 17, 1, 'Test'),
(26, 18, 7, 'Bon jeu à faire entre potes '),
(27, 18, 10, 'Bon jeu quand il bug pas il te faut une config monstre pour éviter les bugs mais bon jeu ');
...
(10, 'Cyberpunk 2077', 'EEA9B8CB-8E22-418B-B310-A2080E8D6AD9.png', 'A364AD74-EECD-4EF2-B681-8505DF33484A.jpeg', 'AFDC3554-B648-4AC5-ADC5-450A8A334126.jpeg', 'ECA36327-247B-4368-B628-EAD15A28285D.jpeg', 'Cyberpunk 2077 est un jeu vidéo d\'action-RPG en vue à la première personne développé par CD Projekt RED, inspiré du jeu de rôle sur table Cyberpunk 2020 conçue par Mike Pondsmith. Le jeu présente un monde futuriste dystopique de type cyberpunk dans lequel la technologie coexiste avec une société humaine dégénérée');
...
(16, 'Rapidecho ', 'sUjbiv-wunjiq-4cetry', 'FALSE'),
(17, 'Gaëlle ', 'Espoirjoliat4', 'FALSE'),
(18, 'Shitorama ', '1111', 'FALSE');
...
--
ALTER TABLE `commentaire`
  MODIFY `id_ commentaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
